...
- (void)initDestinationSearchBar
{
    ...
    home.currenViewController = self;
    ...
    // 驾车助手
    UILabel *assisant = [[UILabel alloc] initWithFrame:kFrame(10, Margin/2, 80, 20)];
    assisant.text = @"驾车助手";
    ...
    {
        // 添加分隔线
        UIImageView *ySeparate = [UIImageView addYSeparateLine:nil Frame:kFrame(0, 0, 1, 30)];
        ySeparate.frame = kFrame(75*i, Margin + 30, 1, 30);
        [driveAssistantView addSubview:ySeparate];
    }
